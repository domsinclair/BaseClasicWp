...
if ( ! function_exists( 'vtlclassic_enqueue_scripts' ) ) :
    ...
    wp_deregister_script( 'vtlclassic-flowbite' );
    wp_enqueue_script( 'vtlclassic-flowbite', get_template_directory_uri() . '/./node_modules/flowbite/dist/flowbite.js', false, null, true);
    ...
    wp_deregister_style( 'vtlclassic-tailwind-1' );
    wp_enqueue_style( 'vtlclassic-tailwind-1', get_template_directory_uri() . '/tailwind_theme/tailwind.css', false, null, 'all');
